...
import ttImg from "../components/images/TT_non_AC.jpg";
import ttacImg from "../components/images/TT_AC.jpg";
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mt-12 bg-orange-50 border-l-4 border-orange-500 p-6 rounded-lg">
          ...
          <ul className="space-y-2 text-gray-700">
            ...
            <li>• Package pricing includes specified kilometer limits - check package details for pricing</li>
            <li>• Prices exclude tolls, parking, and driver allowance</li>
