          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start space-x-3">
                ...
                <a href="tel:+919449449510" className="text-gray-400 hover:text-orange-500 transition-colors">
                  +91 9449449510
                </a>
              </li>
              <li className="flex items-start space-x-3">
                <Mail className="w-5 h-5 text-orange-500 mt-1 flex-shrink-0" />
                <a href="mailto:info@legendvanara.com" className="text-gray-400 hover:text-orange-500 transition-colors">
                  info@legendvanara.com
                </a>
              </li>
              <li className="flex items-start space-x-3">
                <MapPin className="w-5 h-5 text-orange-500 mt-1 flex-shrink-0" />
                <span className="text-gray-400">Kanakapura, Karnataka, India</span>
              </li>
            </ul>
          </div>
